        ...
        <div class="container">
            ...
            <div class="card-grid">
                ...
                <div class="card">
                    ...
                    <button class="orange-btn" onclick="window.location.href='/add_employer'">Управление работодателями</button>
                </div>
                <div class="card">
        ...
        <div class="container">
            ...
            <div class="card-grid">
                ...
                <div class="card">
                    ...
                    <h3>Сделки</h3>
                    <p>Оформленные трудоустройства и комиссия</p>
                    <button class="orange-btn" onclick="window.location.href='/create_deal'">Просмотреть сделки</button>
                </div>
            </div>
        </div>
    </body>
